...
# -*- coding: utf-8 -*-
"""
Transfert - Application de transfert de fichiers TCP
Version 1.0.0
"""
...
class TransfertApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Transfert - TCP File Transfer")
    ...
    def _creer_widgets(self):
        ...
        ttk.Radiobutton(mode_frame, text="🖥️ Client", variable=self.mode_var, 
                       value="client", command=self._changer_mode).pack(side=tk.LEFT, padx=15)
        ttk.Radiobutton(mode_frame, text="📡 Serveur", variable=self.mode_var, 
                       value="serveur", command=self._changer_mode).pack(side=tk.LEFT, padx=15)
        ...
        self.log_text = scrolledtext.ScrolledText(
            log_frame, height=15, font=("Courier", 9),
    ...
    def _action_recevoir(self):
        ...
        if nom:
            ...
            self.log("⚠️ Entrez un nom de fichier.", "warning")
